...
-- Insert sample architecture
INSERT INTO architectures (name, description) VALUES
('UAV Surveillance System', 'Demo: Unmanned aerial vehicle with ground control station');
...
(1, 1, 2, 'telemetry', '{"bandwidth_mbps": 50, "protocol": "internal"}'::jsonb),
(1, 2, 3, 'commands', '{"bandwidth_mbps": 10, "protocol": "encrypted"}'::jsonb);
...
SELECT id, source_component_id, target_component_id, data_type FROM flows;
