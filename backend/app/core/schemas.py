...
class SimulationResultSchema(BaseModel):
    ...
    baseline_score: float = Field(ge=0.0, le=100.0, description="Score before attack (%)")

    # Mission success score AFTER the attack.
    # Formula: (healthy_components / total_components) * 100
    compromised_score: float = Field(ge=0.0, le=100.0, description="Score after attack (%)")
    ...
    score_delta: float = Field(description="Percentage-point drop (negative = degraded)")
    ...
    affected_components: list[str] = Field(description="IDs of affected components")
    ...
    affected_component_names: list[str] = Field(description="Names of affected components")
    ...
    attack_path: list[str] = Field(description="Step-by-step propagation narrative")
